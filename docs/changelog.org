...
:END:
  ...
  Most likely next version number: v5.0.0.1
  ...
  - New functionality
    - configure.sh script runs from root of repository -- not the build directory.
  - Documentation
    - changelog N/A typos fixed in v5.0.0.0
    - Added examples note to main readme
  - Miscellaneous
    - N/A
...
:END:
  ...
  - API breaking Changes
    ...
    - Switched to C++23
    - mjr::math::uply::eval being a template will prevent automatic type conversions in existing code.
  - Deprecated functionality
  - New functionality
    - MRMathODE.hpp: Runge-Kutta methods
      - mjr::math::ode::deqnt_t, mjr::math::ode::deqwt_t - Types for autonomous & nonautonomous ODE functions
      - mjr::math::ode::rk1 - Euler's method for both autonomous & nonautonomous
      - mjr::math::ode::rk4 - Classic RK4 for both autonomous & nonautonomous
    - MRMathESGN.hpp: Enumerated sgn/sign for fast tests for SDF functions on points. Requires C++23.
      - mjr::math::esgn::zero_or_change -- Boundry intersection test
      - mjr::math::esgn::non_zero_change -- Boundary crossing test
      - mjr::math::esgn::count_signs -- Counting signs
      - mjr::math::esgn::sgn & mjr::math::esgn::sgne -- Enumerated sgn/sgne replacements
      - mjr::math::esgn::sgn_to_esgn &mjr::math::esgn::esgn_to_sgn -- Convert enum to/from int
    - mjr::math::ivl
      - Integer overload of mjr::math::ivl::wrapCO
      - Unit tests for integer inputs to mjr::math::ivl::wrapCO
      - Unit tests comparing mjr::math::ivl::wrapCO & mjr::math::ivl::wrapCC on integers.
    - mjr::math::fc
      - mjr::math::fc:not_near_zero for floating point & complex floating point types
    - mjr::math::vec
      - mjr::math::vec::linear_combination overloads for 3 and 4 vectors.
      - mjr::math::vec::scale
    - mjr::math::cplx
      - mjr::math::cplx::iabs()
      - mjr::math::cplx::rabs()
      - mjr::math::cplx::rchs_if_ineg()
      - mjr::math::cplx::is_complex type type trait
    - mjr::math::odr
      - New: mjr::math::odr::abs_max2
      - New: mjr::math::odr::abs_min2
      - New: mjr::math::odr::sort2
      - New: mjr::math::odr::abs_sort2
    - mjr::math::sfun:heaviside()
    - mjr::math::uply
      - mjr::math::eval() is now a template
      - mjr::math::evald() Computes the value of a polynomial and its derivatives.
  - Documentation
    - Removed "examples" item from changelog.org release section template
    - Updated readmes to include CMake note.
    - Added quite a bit of detail to main readme.
    - Added doxygen grouping
    - Added BLAS notes in vector functions
  - Miscellaneous
